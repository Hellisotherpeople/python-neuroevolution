...
X, y = make_moons(n_samples=100, random_state=43, noise=0)
# X, y = make_regression(n_samples=1000, n_features=3,
#            n_informative=1, random_state=43)
...
class Neural_Network(object):
    ...
    def forward(self, X):
        ...
        self.z2 = expit((self.z))  # activation function
    ...
    def compute_fitness(self, w1_canidates, w2_canidates):
        ...
        if self.graph:
            plt.scatter(self.current_iteration, best_canidate)
            plt.pause(0.001)
        else:
            print(best_canidate)
...
NN = Neural_Network(100, 1000, None, None, True)
